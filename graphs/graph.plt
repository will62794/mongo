...
"reconfig-events-standardraft.csv" using ($1):(120) with impulses lc rgb "#880000ff" lw 0.05 lt 5 dt 1 #points lt 8 lw 0.25 lc "blue"
...
"reconfig-events-logless.csv" using ($1):(120) with impulses lc rgb "#880000ff" lw 0.05 lt 5 dt 1 #ps 0.5 lt 8 lw 0.25 lc "blue"
