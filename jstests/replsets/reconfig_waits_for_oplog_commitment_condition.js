...
//
// Now we test that a primary executing a reconfig waits for the first op time of its term to commit
// if it is newer than the latest committed op in a previous config.
//
